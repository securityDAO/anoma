...
impl TestNativeVpEnv {
    /// Run some transaction code `apply_tx` and validate it with the native VP
...
// pub fn init_ctx_from_state<'a>(
//     vp_wasm_cache: VpCache,
//     state: &'a tx_host_env::State,
// ) -> NativeVpCtx<'a> {
//     Ctx {
//         iterators: Default::default(),
//         gas_meter: Default::default(),
//         storage: &state.test_env.storage,
//         write_log: &state.test_env.write_log,
//         tx: &state.tx,
//         vp_wasm_cache,
//     }
// }
